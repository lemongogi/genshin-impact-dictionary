...
def lisa_info(page=1):
    ...
    if infostat==1:
        ...
        if page==1:
            ...
            character_passive3_text.configure(text="리사를 선택하고 포션 합성 시 20%의 확률로 일부 합성 재료를 반환합니다", fg="slateblue2", font=("Comic Sans MS",11))
    else:
        working()
